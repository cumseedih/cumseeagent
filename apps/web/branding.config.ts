 ...
 */
const configuredProductDomain = process.env.NEXT_PUBLIC_PRODUCT_DOMAIN || process.env.PRODUCT_DOMAIN;
...
export const BRANDING = {
  ...
  // Avoid leaking the retired local development identity when a stale environment
  // file is present during a production build.
  PRODUCT_DOMAIN: configuredProductDomain && configuredProductDomain !== "delvin.local" ? configuredProductDomain : "agentdelv.in",
  LOGO_PATH: "/assets/delvin-avatar.jpg",
