  ...
  return (
    <div className="delvin-shell flex h-screen overflow-hidden">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="delvin-topbar flex items-center justify-between border-b border-[#1e2433] bg-[#0b0e14]/95 px-5 py-3 backdrop-blur">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden rounded-full border border-[#263247] bg-[#111827] px-2.5 py-1 text-[10px] uppercase tracking-[0.16em] text-[#9aa0b2] sm:inline-flex">{BRANDING.PRODUCT_DOMAIN}</span>
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Center */}
          <div className="delvin-main flex flex-1 flex-col overflow-hidden bg-[#0b0e14]">
            <div className="flex-1 overflow-auto px-4 py-8 sm:px-8">
              <div className="mx-auto flex min-h-full max-w-3xl flex-col justify-end space-y-5">
                {!messages.length && <div className="delvin-welcome mb-auto flex flex-col items-center justify-center px-4 pb-10 pt-12 text-center">
                  ...
                  <h2 className="text-3xl font-semibold tracking-wide text-[#f3f4f6]">What are we building today?</h2>
                  <p className="mt-3 max-w-xl text-sm leading-6 text-[#8e98aa]">Ask Delvin to inspect, build, fix, or explain your project. Your workspace, terminal actions, and approvals stay visible in one place.</p>
                  {projectId && <div className="mt-5 rounded-full border border-[#202b3c] bg-[#0f1622] px-3 py-1.5 text-[11px] text-[#77849a]">Workspace ready · {projectId.slice(0, 8)}…</div>}
                </div>}
                ...
                <div className="rounded-2xl border border-[#1b2635] bg-[#0e141e]/90 p-3 shadow-[0_16px_50px_rgba(0,0,0,0.14)]">
                  <h3 className="mb-2 px-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-[#718096]">Activity</h3>
            ...
            <div className="border-t border-[#1e2433] bg-[#0b0e14]/95 px-4 py-4 backdrop-blur sm:px-8">
          ...
          <div className="hidden w-[340px] flex-col border-l border-[#1e2433] bg-[#0d121b] xl:flex">
            <div className="border-b border-[#1e2433] p-4">
              <h3 className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#8793a8]">Workspace terminal</h3>
              {sessionId ? <Terminal sessionId={sessionId} /> : <div className="text-xs text-[#6b7280]">Select a session to use terminal.</div>}
            </div>
            <div className="flex-1 overflow-auto p-3">
              <h3 className="mb-3 text-[10px] font-semibold uppercase tracking-[0.2em] text-[#8793a8]">Recent activity</h3>
